...
import { REG_LABELS_2 } from "@/shared/constants/storage";
...
const Question2: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        localStorage.setItem(REG_LABELS_2, selectedLabels.join(";"));
        router.push(RouteConfig.RegisterQuestion3.Path);
    };
        ...
        >
            ...
            >
                <Typography
                    ...
                    Question2: What type of Categories are you interested in?
                </Typography>
                <Box
                    sx={{
                        width: "100%",
