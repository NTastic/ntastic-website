...
import { Avatar, Box, Button, Checkbox, Dialog, DialogContent, DialogTitle, List, ListItem, Typography } from "@mui/material";
...
export default function SelectTags(
    ...
    const { data: tagData } = useQuery(GET_TAGS, { fetchPolicy: "cache-first" });
                ...
                <List sx={{ width: "100%" }}>
                    {tagList.map((item: TagValue) => (
                        <ListItem key={item.id}>
                            <Avatar sx={{ mr: 1, width: "45px", height: "45px" }} />
                            <Box flexGrow={1}>
